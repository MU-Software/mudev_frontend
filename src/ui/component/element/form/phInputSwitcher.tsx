...
export const PHInputSwitcher: React.FC<{
  ...
  const [isOptionEnabled, setOptionEnabledAs] = state
    ? [state.isOptionEnabled, state.setOptionEnabledAs]
    : useState(false)
...
export const PHSwitchableDatePicker: React.FC<{
  ...
  return (
    <PHInputSwitcher disabled={disabled} state={{ isOptionEnabled, setOptionEnabledAs }}>
      <>
        <b>{label}</b>&nbsp;날짜를&nbsp;
      </>
