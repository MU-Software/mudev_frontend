...
export type APIResultDataType<T extends APIResultGenericTypes = APIResultGenericTypes> =
  | T['S']
  | APIResultErrorDataType<T>
...
export type APIRequestCallableType = <T extends APIResultGenericTypes = APIResultGenericTypes>(
  ...args: APIRequestCallableArgumentType
) => Promise<APIResultType<T>>
export type APIResponseHandlerType = <T extends APIResultGenericTypes = APIResultGenericTypes>(
  ...args: APIRequestCallableArgumentType
) => Promise<{
  response: Response
  header: Headers
